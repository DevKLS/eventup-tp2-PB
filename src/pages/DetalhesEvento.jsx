...
function DetalhesEvento() {
  ...
  // Recarrega os dados sempre que o evento ou usuário mudar.
  useEffect(() => {
    carregarDados();
  }, [id, user]);

  // Busca os dados do evento e verifica inscrições e favoritos do usuário.
  async function carregarDados() {
    ...
    if (user) {
      ...
      // Verifica se o evento está salvo nos favoritos do usuário.
  ...
  // Realiza ou cancela a inscrição do usuário no evento.
  ...
  // Adiciona ou remove o evento da lista de favoritos.
  ...
  return (
    <section
      className="section"
      style={{ padding: "40px 0", minHeight: "85vh" }}
    >
      <div className="container">
        ...
        <div
          style={{
            display: "grid",
            gridTemplateColumns:
              "window" in globalThis && window.innerWidth < 992
                ? "1fr"
                : "minmax(0, 1.8fr) minmax(310px, 1fr)",
            gap: "35px",
            alignItems: "start",
          }}
        >
          ...
          >
            ...
            <div style={{ padding: "24px" }}>
              ...
              >
                ...
                >
                  {evento.description ||
                    "Nenhuma descrição adicional informada para este evento comunitário."}
                </p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            {/* Botão responsável por confirmar ou cancelar a inscrição */}
            <div
              style={{
                display: "flex",
                flexDirection: "column",
            ...
            >
              <button
                className={`btn ${
                  confirmado ? "btn-secondary" : "btn-primary"
                }`}
              ...
              {/* Botão para adicionar ou remover o evento dos favoritos */}
              <button
                ...
                onMouseOver={(e) => {
                  e.currentTarget.style.borderColor = favoritado
                    ? "#ef4444"
                    : "var(--text-soft)";
                  if (!favoritado)
